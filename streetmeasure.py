...
from streetmeasure_dialog import streetmeasureDialog
import os.path
...
class streetmeasure:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'streetmeasure_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&streetmeasure')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'streetmeasure')
        self.toolbar.setObjectName(u'streetmeasure')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('streetmeasure', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/streetmeasure/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'streetmeasure'),
            callback=self.run,
...
#------------------------------------------------------------------------
				...
				stringa1 = "https://enricofer.github.io/streetmeasure/?lat="
				stringa2 = ("%s") %(yc)
				stringa3 = "&lon="
				stringa4 = ("%s") %(xc)


				sentinel2 = stringa1 + stringa2 + stringa3 + stringa4
